...
export class FileChangesComponent implements OnInit,
  ...
  constructor(
      ...
      private location: Location, private textDiffService: TextDiffService,
    ...
    this.fileReviewedCheckbox.valueChanges.subscribe(checkboxReviewed => {
      this.userService.toogleFileReview(
          checkboxReviewed, this.reviewer, this.rightFile);
  ...
  private setDiff(diff: Diff): void {
    ...
    this.textDiffService
        .load(
            this.diff, this.filenameWithRepo, this.leftFile.getCommitId(),
