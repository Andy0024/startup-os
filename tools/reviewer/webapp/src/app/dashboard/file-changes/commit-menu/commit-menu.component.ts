...
export class CommitMenuComponent implements OnInit,
  ...
  getCommitId(dragElement: DragElement, dragElement2: DragElement,
              step: number, ): string {
  ...
  moveDragElement(mouseX: number, dragElement: DragElement,
                  dragElement2: DragElement, step: number, ): void {
