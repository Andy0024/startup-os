...
export class TemplateService {
  ...
  getLineBackground(changesLine: ChangesLine, blockIndex: BlockIndex,
  ...
  private makeHighlighting(wordChanges: WordChange[], code: string,
    ...
    wordChanges.forEach(wordChange => {
      ...
      let codeWithWordChange: string =
          code.substr(wordChange.getStartIndex(),
