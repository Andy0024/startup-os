...
export class LineService {
  ...
  createBlockLine(code: string, clearCode: string,
                  lineNumber: number, ): BlockLine {
  ...
  createChangesLine(leftBlockLine: BlockLine,
                    rightBlockLine: BlockLine, ): ChangesLine {
    const changesLine: ChangesLine = this.createEmptyChangesLine();
    changesLine.blocks = [ leftBlockLine, rightBlockLine ];
    return changesLine;
  }

  createCommentsLine(leftBlockLine: BlockLine,
                     rightBlockLine: BlockLine, ): ChangesLine {
