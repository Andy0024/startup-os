...
describe('ThreadComponent', () => {
  ...
  it('should contain a comment', () => {
    const div: HTMLElement =
        fixture.nativeElement.querySelector('.comment .header .username');
  ...
  it('should expand a comment', () => {
    const debugElement: DebugElement =
        fixture.debugElement.query(By.css('.comment'), );
    debugElement.triggerEventHandler('click', null);
    fixture.detectChanges();
    const span: HTMLElement =
        fixture.nativeElement.querySelector('.comment .header .time span', );
  ...
  it('should open reply', () => {
    const debugElement: DebugElement = fixture.debugElement.query(
        By.css(
            '.comment .message .action-panel .comment-buttons .cr-thread-button'), );
    debugElement.triggerEventHandler('click', null);
    fixture.detectChanges();
    const textarea: HTMLElement =
        fixture.nativeElement.querySelector('.comment .message textarea', );
