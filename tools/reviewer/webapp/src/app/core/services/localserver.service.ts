...
export class LocalserverService {
  ...
  getFileChanges(leftFile: File,
                 rightFile: File, ): Observable<TextDiffResponse> {
    return new Observable(observer => {
  ...
  private addWithReplace(fileDictionary: {[filename: string] : File},
                         newfiles: File[], ): void {
  ...
  getFileData(filenameWithRepo: string,
              branchInfoList: BranchInfo[], ): FileData {
    for (const branchInfo of branchInfoList) {
