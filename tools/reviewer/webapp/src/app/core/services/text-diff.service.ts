...
export class TextDiffService {
  ...
  load(
      diff: Diff, filenameWithRepo: string, defaultLeftCommitId?: string,
  ...
  private getFiles(
      file: File, branchInfo: BranchInfo, leftCommitId: string,
  ...
  private getLocalThreads(
      diff: Diff, file: File, leftCommitId: string,
