...
export class NotificationService {
  ...
  snack(
      message: string, action: string = '', duration: number = null,
  ...
  success(message: string, action: string = '', duration: number = null, ):
      void {
  ...
  warning(message: string, action: string = '', duration: number = null, ):
      void {
